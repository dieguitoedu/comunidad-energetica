        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="aspect-[4/3] rounded-[40px] overflow-hidden shadow-2xl relative border-8 border-white">
              ...
              <div className="absolute bottom-6 left-6 md:bottom-8 md:left-8 p-6 bg-white/95 backdrop-blur rounded-2xl shadow-xl max-w-xs border border-primary/10">
                <div className="flex items-center gap-4 mb-4 text-primary">
                  <Power className="w-6 h-6 md:w-8 md:h-8" />
                  <div className="h-0.5 flex-1 bg-primary-light" />
                </div>
                <p className="text-black font-serif italic text-base md:text-md font-bold leading-snug">
